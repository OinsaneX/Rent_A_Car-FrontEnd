...
export default function UserManager({ users }) {
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            await axios
              .delete(`https://desolate-sea-14156.herokuapp.com/user/${id}`)
              .then(() => {
                NotificationManager.success(
                  "Usuario Eliminado con suceso",
                  "Éxito",
                  2000
                );
                getUsers();
  ...
  async function getUsers() {
    await axios
      .get("https://desolate-sea-14156.herokuapp.com/user")
      .then((response) => {
                  ...
                  user.role == "admin" && (
                    <tr key={user._id}>
                      ...
                      <td data-col-title="Opciones" className="flex">
                        <label onClick={() => deleteUser(user._id)}>
                          <Delete />
                        </label>{" "}
