...
export default function AddCar() {
    ...
    const [carData, setcarData] = useState({brand:'',model:'',description:'',imageUrl:'',price_per_day:0})
               ...
               <h2>Agregar nuevo auto al sistema</h2>
                ...
                <section>
                    ...
                    <form action="submit">
                        ...
                        <input type="text" name="brand" onChange={(e)=>onWrite(e)} placeholder="Marca"/>
                        <input type="text" name="model" onChange={(e)=>onWrite(e)} placeholder="Modelo"/>
                        <h4>Descripción :</h4>
                        <textarea name="description" onChange={(e)=>onWrite(e)} id="" cols="30" rows="10"></textarea>
                        <input type="number" name="price_per_day" onChange={(e)=>onWrite(e)} placeholder="Precio por dia"/>
