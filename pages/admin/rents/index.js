    ...
    <>
      ...
      <main>
        <section>
          ...
          <div className="list">
            {actives.length < 1 ? (
              <h3>No existe ninguna renta activa en el sistema</h3>
            ) : (
              actives.map((rent) => (
                <div className="card">
                  <div className="col">
                  ...
                  <div className="buttons">
                    <Link href={`/admin/rents/${rent._id}`}>
                      <a>Ver Detalles</a>
                    </Link>
                  </div>
                </div>
        ...
        <section>
          ...
          <div className="list">
            {canceled.length < 1 ? (
              <h3>No existe ninguna renta cancelada en el sistema</h3>
            ) : (
              canceled.map((rent) => (
                <div className="card">
                  <div className="col">
        ...
        <section>
          ...
          <div className="list">
            {noactive.length < 1 ? (
              <h3>No existe ninguna renta inactiva en el sistema</h3>
            ) : (
              noactive.map((rent) => (
                <div className="card">
                  <div className="col">
                  ...
                  <div className="col">
                    ...
                    <h3>
                      {!rent.active
                        ? "El usuario borró su cuenta"
                        : "El usuario no confirmó la renta"}
                    </h3>
                  </div>
                  <div className="buttons">
                    <Link href={`/admin/rents/${rent._id}`}>
