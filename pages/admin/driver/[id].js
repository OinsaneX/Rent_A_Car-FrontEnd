...
export const getServerSideProps = async (ctx) => {
    ...
    var works =null
    var user = null
    await axios.get(`https://desolate-sea-14156.herokuapp.com/user/${id}`).then(async(res) => {
        user=res.data
        await axios.get(`https://desolate-sea-14156.herokuapp.com/rent/getRentsByDriver/${user._id}`)
        .then(response => {
            works = response.data
                  })
