...
export default function Profile() {
    ...
    getUser(async (res) => {
      if (!res) {
        ...
        if (res.role == "driver") {
          await axios
            .get(
              `https://desolate-sea-14156.herokuapp.com/rent/getRentsByDriver/${res._id}`
            )
  ...
  const getRents = async (res_id) => {
    await axios
      .get(`https://desolate-sea-14156.herokuapp.com/rent/user/${res_id}`)
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            await axios
              .get(`https://desolate-sea-14156.herokuapp.com/rent/${id}/cancel`)
              .then(() => {
                NotificationManager.success(
                  "Renta cancelada con suceso",
                  "Ok",
                  3000
                );
                getRents();
